...
export default function Project() {
  ...
  return (
    <main className="bg-yellow-100 min-h-screen p-3">
          ...
          {projectData &&
            projectData.map((project, index) => (
              ...
              <div className="p-12 md:w-1/2 flex flex-col items-start">
               <div class="bg-white h-full px-8 pt-12 pb-12 rounded-lg overflow-hidden  relative shadow-xl"> 
                ...
                <div className="text-gray-500 text-xs space-x-1 ">
                  <span className="inline-block py-1 px-2 mb-2 rounded bg-yellow-100 text-yellow-500 text-xs font-medium tracking-widest">
